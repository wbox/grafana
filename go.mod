...
require (
	...
	github.com/grafana/alerting v0.0.0-20250404144709-7ec12d1e7cee // @grafana/alerting-backend
...
replace github.com/prometheus/alertmanager => github.com/grafana/prometheus-alertmanager v0.25.1-0.20250404144626-9bb1365fb400
